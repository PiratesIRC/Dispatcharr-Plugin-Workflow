...
All plugins in this guide are developed and maintained by [PiratesIRC](https://github.com/PiratesIRC). Star the repos if you find them useful, and report issues directly on the relevant GitHub project.

| Plugin | Repository |
| --- | --- |
| Lineuparr (one-click alternative) | [Dispatcharr-Lineuparr-Plugin](https://github.com/PiratesIRC/Dispatcharr-Lineuparr-Plugin) |
| IPTV Checker | [Dispatcharr-IPTV-Checker-Plugin](https://github.com/PiratesIRC/Dispatcharr-IPTV-Checker-Plugin) |
| Channel Mapparr | [Dispatcharr-Channel-Maparr-Plugin](https://github.com/PiratesIRC/Dispatcharr-Channel-Maparr-Plugin) |
